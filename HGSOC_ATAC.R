...
labels <- c("3-Epithelial cell","15-Empty_Epithelial cell","2-Epithelial cell","19-Epithelial cell",
            "0-Epithelial cell","11-Epithelial cell","7-Epithelial cell","16-Epithelial cell")
...
popular.groups <- summary(factor(proj.filter$predictedGroup_ArchR))
popular.groups <- popular.groups[popular.groups > 30]
proj.filter$Mode.Label <- ifelse(proj.filter$predictedGroup_ArchR %in% names(popular.groups),TRUE,FALSE)
